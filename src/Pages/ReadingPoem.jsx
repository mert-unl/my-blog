...
export default function ReadingPoem(){
    ...
    return(
        <>  
            <div className="flex flex-col gap-4  mt-4 md:mt-12 md:py-12 md:px-120  py-16 px-4 ">
                ...
                <p className="text-sm md:text-xl  text-gray-300 italic whitespace-pre-line leading-relaxed tracking-wide">{poem.content}</p> 
                { poem.comment && (
                    <div className="border-1  p-3 rounded-lg mt-6 w-fit border-gray-400">
                        <p className="text-sm md:text-md text-gray-300">Meraklısına;</p>
                        <p className="text-sm  md:text-md  mt-1 ms-2 text-gray-300">{poem.comment}</p>
                    </div>)
                }
            </div> 
        </>
